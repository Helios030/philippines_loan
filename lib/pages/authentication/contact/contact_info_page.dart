        ...
        if (s_contact_result.code == "200") {
          ...
          if (sContactInfo != null) {
            ...
            if (sContactInfo!.relation1 != null) {
              //服务器从1开始
              relation_1 = DicUtil.array_first_contact[int.parse(
                  sContactInfo!.relation1!) - 1].menuName;
            }
            if (sContactInfo!.relation2 != null) {
              //服务器从1开始
              relation_2 = DicUtil.array_second_contact[int.parse(
                  sContactInfo!.relation2!) - 1].menuName;
            }
            ...
            if (sContactInfo!.relation3 != null) {
              relation_3 = DicUtil.array_first_contact[int.parse(
                  sContactInfo!.relation3!) - 1].menuName;
            }
            if (sContactInfo!.relation4 != null) {
              relation_4 = DicUtil.array_first_contact[int.parse(
                  sContactInfo!.relation4!) - 1].menuName;
            }
            if (sContactInfo!.relation5 != null) {
              relation_5 = DicUtil.array_first_contact[int.parse(
                  sContactInfo!.relation5!) - 1].menuName;
            }
          }
          setState(() {});
        } else {
          ...
          Container(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    TextView(S
                        .of(context)
                        .contact_name_f, color: N.orange37,
                      textAlign: TextAlign.left,),
                    ItemTextView(S.current.relationship_with_you, relation_1,
                      onSelected: (menu) {
                    ...
                    ItemTextView(
                        S.current.contact_number, first_phone, onClick: () {
                    ...
                    ItemTextView(S
                        .of(context)
                        .contact_name, first_name, onClick: () {
                      selectContact().then((value) {
                        if (value != null) {
                          first_name = value.fullName!;
                          first_phone = value.phoneNumber!.number!.toString();
                    ...
                    TextView(S
                        .of(context)
                        .contact_name_s, color: N.orange37,
                      textAlign: TextAlign.left,),
                    ItemTextView(S.current.relationship_with_you, relation_2,
                      onSelected: (menu) {
                    ...
                    ItemTextView(
                        S.current.contact_number, second_phone, onClick: () {
                      selectContact().then((value) {
                        if (value != null) {
                          first_name = value.fullName!;
                          first_phone = value.phoneNumber!.number!.toString();
                          contactDataMap["name_relation_2"] = first_name;
                          contactDataMap["phone_relation_2"] = first_phone;
                          setState(() {});
                        }
                      });
                    }),
                    ItemTextView(S
                        .of(context)
                        .contact_name, second_name,onClick: () {
                      selectContact().then((value) {
                        if (value != null) {
                          first_name = value.fullName!;
                          first_phone = value.phoneNumber!.number!.toString();
                    ...
                    TextView(S
                        .of(context)
                        .contact_name_three, color: N.orange37,
                      textAlign: TextAlign.left,),
                    ItemTextView(S.current.relationship_with_you, relation_3,
                      onSelected: (menu) {
                        relation_3 = menu.menuName;
                        contactDataMap['relation3'] = menu.menuCode;
                      }, datas: DicUtil.array_first_contact,),
                    ItemTextView(S.current.contact_number, phone_3,onClick: () {
    selectContact().then((value) {
    if (value != null) {
    first_name = value.fullName!;
    first_phone = value.phoneNumber!.number!.toString();
    contactDataMap["name_relation_3"] = first_name;
    contactDataMap["phone_relation_3"] = first_phone;
    setState(() {});
    }
    });
    }),
                    ...
                    TextView(S
                        .of(context)
                        .contact_name_four, color: N.orange37,
                      textAlign: TextAlign.left,),
                    ...
                    ItemTextView(S.current.contact_number, phone_4,onClick: () {
                      selectContact().then((value) {
                        if (value != null) {
                          first_name = value.fullName!;
                          first_phone = value.phoneNumber!.number!.toString();
                          contactDataMap["name_relation_4"] = first_name;
                          contactDataMap["phone_relation_4"] = first_phone;
                          setState(() {});
                        }
                      });
                    }),
                    ...
                    TextView(S
                        .of(context)
                        .contact_name_five, color: N.orange37,
                      textAlign: TextAlign.left,),
                    ...
                    ItemTextView(S.current.contact_number, phone_5,onClick: () {
                      selectContact().then((value) {
                        if (value != null) {
                          first_name = value.fullName!;
                          first_phone = value.phoneNumber!.number!.toString();
                          contactDataMap["name_relation_5"] = first_name;
                          contactDataMap["phone_relation_5"] = first_phone;
                          setState(() {});
                        }
                      });
                    }),
