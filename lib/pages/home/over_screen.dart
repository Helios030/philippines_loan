...
class OverScreenWidget extends StatefulWidget {
  ...
  const OverScreenWidget(
      this.loanResult, {
        Key? key,
      }) : super(key: key);

  @override
  State<OverScreenWidget> createState() => _OverScreenWidgetState();
}
...
class _OverScreenWidgetState extends State<OverScreenWidget> {
  ...
  void initState() {
    ...
    if (widget.loanResult != null) {
      Slog.d("逾期  widget.loanResult      ${widget.loanResult}");
      ...
      fale_fee =  widget.loanResult!.faleFee.toString();
      penalty  =  widget.loanResult!.penalty.toString();
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  showTextView(S.current.fale_fee, fale_fee),
                  showTextView(S.current.penalty, penalty),
                  showTextView(S.current.withdrawal_method, withdrawal_method),
                  showTextView(S.current.withdrawal_method_number, withdrawal_method_number, isShowLine: false,),
                ],
              ),
            ),
            Container(
